...
insert into `MEAL`(`MEAL_NAME`,`MEAL_PRICE`, `MEAL_INFO`)
values
    ('頂級月子餐',699,'有著多年月子餐經驗的專業主廚，率領五星級廚藝團隊，堅持古法熬製湯品，使用新鮮食材與薄鹽少油，加上天然的烹調，為您打造出道道精彩的美味月子飲食。'),
    ('月芽養生月子餐',599,'月芽聘請專業中醫師、營養師、護理師，以現代食品營養學角度討論研發配方，餐飲源自於最高規格、品質與新鮮食材，透過食療的方式調理孕、產婦體質、滋補養身、增強體力，讓下一代更健康與茁壯。'),
    ('尊爵月子餐',499,'健康鮮滋味，讓您營養好心情。雙主菜設計，補充優質蛋白質與多重營養素溫和漸進式調養，滿足現代人坐月子膳食需求。'),
    ('芽果膳食月子餐',1099,'秉持著『食藥同源』的觀念，月子期間的藥膳大多使用溫補的中藥材與食材搭配，烹調成美味又補身的佳餚，專為產後幫助恢復身體而設計。'),
    ('靚媽咪月子餐',399,'結合了傳統的產後藥膳食補與現代營養學的概念，以大骨精燉的湯底來烹調出最適合產後媽媽食用的餐點。'),
    ('藥膳月子餐',449,'食補、藥補、休息。藥膳月子餐是由獨家配方搭配頂級草本漢材之養生法精製而成，能讓妳快速達到恢復健康、回復身材的效果。'),
    ('精緻月子餐',349,'針對產後所需提供營養、豐盛及多變化的菜色，把握產後黃金時期，由資深助產士及中、西醫師團隊來為您階段性調理。');
...
insert into `MEAL_ORDER`(`USER_ID`,`ORDER_PAYMENT`,`AUTH_CODE`)
values
    (1,1,'12344321'),
    (2,1,'aabbaabb'),
    (3,1,'okokokok'),
...
values(1,'姜儼軒','09939183',"早上9點-12點",'2023-04-08','sam232142@yahoo.com.tw','2','2023-04-08','JAVA好難'),
      (2,'吳敦義','09938712',"下午1點-6點",'2023-06-18','Jerry232142@google.com','1','2023-10-21','我是誰我在哪裡'),
      (3,'蔡英文','095939293',"晚上7點-9點",'2023-03-29','David232142@yahoo.com.tw','3','2023-07-08','我終於要下台了,不用被罵了,YA!'),
      (4,'馬英九','09949301',"下午1點-6點",'2023-04-12','BigWu8080@yahoo.com.tw','5','2023-04-18','我要參加三項鐵人4'),
      (5,'柯文哲','09984892',"早上9點-12點",'2023-05-28','AntomWu55688@yahoo.com.tw','1','2024-012-08','我要選總統請投我一票'),
      (6,'賴清德','09984892',"早上9點-12點",'2023-05-28','AntomWu55688@yahoo.com.tw','1','2024-012-08','我要選總統請投我一票');
