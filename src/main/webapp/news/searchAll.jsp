...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/news/css/front_search.css">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item" href="/elitebabynews/news/front_allnews.jsp">綜合</a></li>
  ...
  <section class="sec1 -type1">
    <div class="flex_container">
      <div class="flex_items -left">
          <div>
          <img class="figure-img img-fluid rounded" src="<%=request.getContextPath()%>/LatestNewsServlet?action=get_photo&&newsId=${result.newsId}">
          </div>
      </div>
      <div class="flex_items -right">
        <a href="/elitebaby/LatestNewsServlet?action=FindBynewsId&&newsId=${result.newsId}">
          <div>
          <a class="title" href="/elitebaby/LatestNewsServlet?action=FindBynewsId&&newsId=${result.newsId}">${result.postTitle}</a>
          </div>
          <div>
          <a class="intro" href="/elitebaby/LatestNewsServlet?action=FindBynewsId&&newsId=${result.newsId}">${result.newsIntro}</a>
          </div>
        </a>
      </div>
    </div>
