                      ...
                      fetch("http://localhost:8080/elitebaby/VisitCJson?action=JSON",{header:("Content-type:application/json;charset=utf-8")})
				.then(resp => resp.json())
				.then(visit => {
					resData = visit;
                    ...
                    let resData = [];
                     document.querySelector("#testb").addEventListener("click",function(){
