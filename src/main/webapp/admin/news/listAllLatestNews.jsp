...
<div class="container">
    ...
    <!-- 搜尋欄位 -->
  <button style="margin-left: 10px" class="btn" onclick="location.href='/elitebaby/admin/news/addLatestNews.jsp'">新增</button>
...
<!-- 				<input  class="btn btn-Revise" type="submit" value="送出"> -->
		...
		<table>
			...
			<tbody>
				<tr>
					<td><img class="figure-img img-fluid rounded" src="<%=request.getContextPath()%>/LatestNewsServlet?action=get_photo&&newsId=${latestNewsVO.newsId}"></td>
					...
					<td>
						<FORM METHOD="post"
							...
							<!--<input type="hidden" name="adminId" value=${latestNewsVO.adminId}> -->
