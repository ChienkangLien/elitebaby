...
<body class="c2">
	...
	<div id="main_div">
		...
		<div class="t2" id="title">消息照片-搜尋</div>
	</div>
...
<ul style="margin-left:500px">
  <li><a href='/elitebaby/admin/news/listAllNewsPhoto.jsp'>表單</a>   <br><br></li>
	<li>
		<FORM METHOD="post" ACTION="/elitebaby/NewsPhoto.do">
			<b>輸入照片編號 (如1):</b> <input type="text" name="photoId"> <input
	...
	<ul>
		<li><a href='/elitebaby/admin/news/addNewsPhoto.jsp'>新增</a> </li>
	</ul>
</ul>
	<!-- bootstrap引用cdn -->
	<script
