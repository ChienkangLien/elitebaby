...
<ul style="margin-left:500px">
  <li><a href='/elitebaby/admin/news/listAllNewsSort.jsp'>表單</a><br><br></li>
	<li>
		<FORM METHOD="post" ACTION="/elitebaby/NewsSort.do">
			<b>輸入種類編號 (如1):</b> <input type="text" name="sortId"> <input
	...
	<ul>
		<li><a href='/elitebaby/admin/news/addNewsSort.jsp'>新增</a> </li>
	</ul>
</ul>
	<!-- 登出彈跳視窗Modal -->
    <div
