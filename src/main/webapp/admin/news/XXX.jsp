...
<!--     css連結 -->
    <link rel="stylesheet" href="admin/news/css/official.css" />
<!--   bootstrap引用cdn -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.1/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-F3w7mX95PdgyTmZZMECAngseQB83DfGTowi0iMjiWaeVhAn4FJkqJByhZMI3AhiU" crossorigin="anonymous" />
     <link rel="stylesheet" href="admin/news/css/front_allnews.css" />
<!--     jquery ui連結 -->
...
<%--   </c:forEach> --%>
 ...
 <script src="./vendors/jquery/jquery-3.6.3.min.js"></script>
  <script src="admin/news/js/jquery-ui.js"></script>
    <!-- bootstrap引用cdn -->
