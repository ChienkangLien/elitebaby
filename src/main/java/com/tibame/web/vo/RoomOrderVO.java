...
public class RoomOrderVO implements Serializable{
	...
	public RoomOrderVO(Integer roomOrderId, String roomTypeName, String roomName, Date orderStartDate,
			Date orderEndDate, Timestamp orderCreateTime, Timestamp orderChangeTime, String orderResident,
			Integer orderPrice, String orderRemark, Integer userId, Integer adminId, String orderStatus) {
		super();
